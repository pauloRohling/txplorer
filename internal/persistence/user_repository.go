...
func (repository *UserRepository) Create(ctx context.Context, name string, email string, password string) (*user.User, error) {
	id, err := uuid.NewV7()
	if err != nil {
		return nil, err
	}
...
func (repository *UserRepository) FindByEmail(ctx context.Context, email string) (*user.User, error) {
