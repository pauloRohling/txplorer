...
func (repository *AccountRepository) Create(ctx context.Context, userId uuid.UUID) (*account.Account, error) {
	id, err := uuid.NewV7()
	if err != nil {
		return nil, err
	}
...
func (repository *AccountRepository) AddBalanceById(ctx context.Context, id uuid.UUID, balance int64) (*account.Account, error) {
...
func (repository *AccountRepository) GetById(ctx context.Context, id uuid.UUID) (*account.Account, error) {
...
func (repository *AccountRepository) GetByUserId(ctx context.Context, userId uuid.UUID) (*account.Account, error) {
